...
class Git(val repo: String) {
    companion object{
        ...
        const val FORMAT = "{${FAKE_SEP}commit$FAKE_SEP:$FAKE_SEP%H$FAKE_SEP,${FAKE_SEP}author$FAKE_SEP:$FAKE_SEP%aN<%aE>$FAKE_SEP,${FAKE_SEP}date$FAKE_SEP:$FAKE_SEP%ad$FAKE_SEP,${FAKE_SEP}message$FAKE_SEP:$FAKE_SEP%f$FAKE_SEP}"
    }
